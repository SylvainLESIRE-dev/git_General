...
$BDDFile = "C:\Users\psle01243\OneDrive - SNCF\page d'accueil\DB_survivalGuide.csv"
# import DB
...
# copy old file
copy-item "C:\Users\psle01243\OneDrive - SNCF\page d'accueil\Page_acc.html" -Destination "C:\Users\psle01243\OneDrive - SNCF\Documents\Tools\Powershell\Create-survivalGuide\Page_acc.BKP" -Force

# create HTML
$HTMLdoc | Out-File "C:\Users\psle01243\OneDrive - SNCF\page d'accueil\Page_acc.html" -Encoding utf8

# copy new file
copy-item "C:\Users\psle01243\OneDrive - SNCF\page d'accueil\Page_acc.html" -Destination "C:\Users\psle01243\OneDrive - SNCF\Documents\Tools\Powershell\Create-survivalGuide\Page_acc.New" -Force

# Copy BDD
copy-item $BDDFile -Destination "C:\Users\psle01243\OneDrive - SNCF\Documents\Tools\Powershell\Create-survivalGuide\DB_survivalGuide.csv.bkp" -Force

# script path
$scriptfolder = split-path -parent $MyInvocation.MyCommand.Definition
# select file to delete
$filetodelete = dir $scriptfolder -Exclude *.zip,*.ps1,*old | where {$_.FullName -notlike "*Archive*"}
# select file to bkp
$filetobackup = dir $scriptfolder -Exclude *.zip  | where {$_.FullName -notlike "*Archive*"}

# date format ANNEEMOISJOUR
$datef = Get-Date -Format "yyyyMMdd"
# bkp file path
$bkpfilePath  = $scriptfolder + "\" + $datef + "_Bkp_SurvivalGuide.zip"
